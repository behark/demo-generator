export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-[#060A0C] pt-24 sm:pt-28 pb-12"
    >
      <div
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.55) 45%, rgba(6,10,12,0.96) 100%)",
        }}
        aria-hidden
      />

      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
        <div className="eyebrow text-[#7DD4E2] fade-up fade-up-1">
          Klinikë dentare · Prizren
        </div>
        ...
        <h1 className="font-[family-name:var(--font-playfair)] font-semibold tracking-tight mt-6 mb-5 text-[clamp(3rem,7.5vw,6.25rem)] leading-[0.95] fade-up fade-up-2">
          Më e mira.
          <span className="block italic font-normal text-[#7DD4E2] -mt-1">
            Pa debat.
          </span>
        </h1>

        <p className="max-w-2xl mx-auto text-lg sm:text-xl text-white/75 font-light leading-relaxed fade-up fade-up-3">
          Klinikë dentare moderne në Prizren — trajtime pa dhimbje, ekip me përvojë dhe teknologji e re. Rezervoni në WhatsApp brenda 60 sekondash.
        </p>

        <div className="flex items-center justify-center gap-6 mt-10 fade-up fade-up-3">
          <div className="flex items-center gap-3 text-white/70 text-sm">
            <span className="w-8 h-px bg-[#7DD4E2]" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-10 fade-up fade-up-4">
          <a
            href="#rezervo"
            className="group inline-flex items-center gap-2 bg-[#7DD4E2] text-[#060A0C] font-medium px-7 py-3.5 rounded-full text-[0.95rem] tracking-wide transition-all hover:bg-white w-full sm:w-auto justify-center"
          >
            Rezervo Vizitën
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs text-white/55 fade-up fade-up-4">
          ...
          <span>· Trajtim pa dhimbje</span>
          <span>· Sterilizim EU</span>
        </div>
      </div>
