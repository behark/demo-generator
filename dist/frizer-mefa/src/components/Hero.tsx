  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?auto=format&fit=crop&w=2400&q=80')" }}
        aria-hidden
      />
      <div
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
        ...
        <p className="max-w-2xl mx-auto text-lg sm:text-xl text-white/75 font-light leading-relaxed fade-up fade-up-3">
          Frizeri për burra që kuptojnë se detajet kanë rëndësi. Rezervoni terminin dhe ne kujdesemi për pjesën tjetër.
        </p>

        <div className="flex items-center justify-center gap-6 mt-10 fade-up fade-up-3">
          <div className="flex items-center gap-3 text-white/70 text-sm">
            <span className="w-8 h-px bg-[#E8C877]" />
            Rezervim i shpejtë në WhatsApp
            <span className="w-8 h-px bg-[#E8C877]" />
          </div>
        </div>
