export default function Location() {
  return (
    <section id="standort" className="py-20 sm:py-32 bg-white">
          ...
          <div className="grid sm:grid-cols-2 gap-6 self-start">
            ...
            <div className="border-t border-[{{COLOR_INK}}] pt-6 sm:col-span-2">
              ...
              <div className="text-[{{COLOR_INK}}]/75 space-y-1.5 tabular-nums">
                <div className="flex justify-between gap-6"><span>Montag – Freitag</span><span>{{HOURS_WEEKDAY}}</span></div>
                <div className="flex justify-between gap-6"><span>Samstag</span><span>{{HOURS_SATURDAY}}</span></div>
                <div className="flex justify-between gap-6"><span>Sonntag</span><span className="text-[{{COLOR_PRIMARY}}]">{{HOURS_SUNDAY}}</span></div>
              </div>
            </div>
            <div className="border-t border-[{{COLOR_INK}}] pt-6 sm:col-span-2">
